 ...
 */
public class MoveAndKeppTouch extends Fragment implements View.OnClickListener{
    Context mContext;
    ...
    public void initSourceSelector(Spinner sourcespin, final Spinner howOftenSpinner) {
        Category categories = DBManager.getCategoryByName(mContext, "Moving Around & Keeping In Touch");
