 ...
 */
public class FunAndEntertainment extends Fragment implements View.OnClickListener{
    Context mContext;
    ...
    public void initSourceSelector(Spinner sourcespin, final Spinner howOftenSpinner) {
        Category categories = DBManager.getCategoryByName(mContext, "Fun & Entertainment");
